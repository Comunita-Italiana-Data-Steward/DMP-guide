...
![Screenshot of the edit button on GitHub](./assets/edit_button.png)
...
One you have finished working, [commit your changes](), [push them to your fork]() then head on the fork's homepage.
...
- `chore:` a change related to housekeeping tasks, like editing github action files, READMEs, CHANGELOGs, etc...
...
## Adding contributors
We use the [All Contributors Bot]() to track contributors.
...
# Style Guide
To ensure cohesiveness, follow the project's [Style Guide](STYLE_GUIDE.md).
