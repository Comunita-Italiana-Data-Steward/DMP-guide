...
This is the code of conduct that everyone who contributes to this project agrees to follow.

> [!IMPORTANT]
> The code of conduct is currently a placeholder.
> A better, more specific Code will be discussed and created as soon as possible.
> Even as tentative, the Code still applies in its entirety.
...
reported by contacting the organization coordinators (see the [MANAGERS.md](https://github.com/Comunita-Italiana-Data-Steward/.github/blob/main/COORDINATORS.md) file). All
